function [x_min, f_min, iter] = Newton_LineSearch(f, gf, Hf, x0, stop_tol, c1, c2, varargin)
    if nargin <  5, stop_tol = 1e-3;  end
    if nargin <  6, c1 = 1e-5;        end
    if nargin <  7, c2 = 1e-5;        end
    alpha_max = 100;
